    ...
    <Grid
        ...
        <Grid item xs={isMobile?12:6} sx={{height:'100%'}}>
            ...
            <Grid item xs={12} sx={{height:'100%'}}>
                ...
                {isMobile ? null : (
    <Box sx={{height:'100%',position: 'relative',top: isMobile?'0px':'-50px', right: isMobile?'0px':'0px',justifyContent:'center',display:'flex'}}><Typography fontSize={64}>Welcome Back</Typography></Box>
    
  )}
                
                
            </Grid>
            <Grid item xs={12} sx={{height:'100%',position: 'relative',top: isMobile?'0px':'-200px', right: isMobile?'0px':'20px',justifyContent:'center',display:'flex' }}>
            <Image
...
{isMobile ? null : (
    <Box
      sx={{
        ...
        width: 0,
        height: 0,
        borderTop: '450px solid transparent',
        borderLeft: '770px solid #0B254A', 
